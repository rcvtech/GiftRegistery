                ...
                <tbody>
                    ...
                    if (sizeof($wishlist_items) > 0) :
						...
						<tr><!-- the tds need to be individual for woothemes responsive mode, since they target the first td specifically and hide it. WIth colspan this causes issues once in responsive mode -->
							...
							<td class="product-purchase"><a href="<?php echo woocommerce_wishlist_url_add_all_to_cart($wishlist->id, $wishlist->get_wishlist_sharing() == 'Shared' ? $wishlist->get_wishlist_sharing_key() : false ); ?>" class="button alt wl-add-all"><?php _e('Add All To Cart', 'wc_wishlist'); ?></a></td>
						</tr>
                    <?php endif; ?>
                </tbody>
            </table>
